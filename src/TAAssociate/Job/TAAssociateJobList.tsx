...
export function TAAssociateJobList() {
  const mockJobs: JobItem[] = [
    { id: "JOB-0001", jobRole: "Senior Frontend Developer", priority: "High", status: "Active", hiringLead: "Jennifer Adams", sampleCVUrl: "https://www.w3.org/WAI/WCAG21/Techniques/pdf/PDF1.pdf", sampleJDUrl: "https://www.w3.org/WAI/WCAG21/Techniques/pdf/PDF2.pdf", stalledCount: 3, approvalMethod: "auto" },
    { id: "JOB-0002", jobRole: "Backend Engineer", priority: "Medium", status: "Active", hiringLead: "Michael Brown", sampleCVUrl: "https://www.w3.org/WAI/WCAG21/Techniques/pdf/PDF1.pdf", approvalMethod: "manual" },
