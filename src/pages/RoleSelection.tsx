      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center bg-white px-8 py-10">
        ...
        <div className="max-w-sm mx-auto w-full mt-8">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ? "border-[#4EAD3B] bg-[#4EAD3B]/6 shadow-sm"
                      : "border-gray-200 bg-white hover:border-gray-300 hover:bg-gray-50/60"
                  )}
                >
                  <p className={cn("text-sm font-semibold leading-none mb-1", isSelected ? "text-[#2d7a22]" : "text-gray-800")}>
                    {role.label}
                  </p>
          ...
          <button
            ...
            className="w-full h-11 rounded-lg text-sm font-semibold transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed"
            style={{ backgroundColor: "#4EAD3B", color: "#1a1a1a" }}
          >
