...
export function JobList() {
  const allJobs: JobItem[] = [
    ...
    { id: 3, jobRole: "Senior Developer", status: "Active", recruiter: "Emma Rodriguez", stalledCount: 2 },
    ...
    { id: 8, jobRole: "QA Engineer", status: "Active", recruiter: "Nina Patel", stalledCount: 1 },
