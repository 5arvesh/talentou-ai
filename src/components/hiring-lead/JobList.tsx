...
export function JobList() {
  const allJobs: JobItem[] = [
    ...
    { id: 2, jobRole: "Product Manager", status: "In Review", recruiter: "David Wilson" },
    { id: 3, jobRole: "Senior Developer", status: "Active", recruiter: "Emma Rodriguez", stalledCount: 2, approvalMethod: "auto" },
    ...
    { id: 8, jobRole: "QA Engineer", status: "Active", recruiter: "Nina Patel", stalledCount: 1, approvalMethod: "manual" },
    { id: 9, jobRole: "Marketing Manager", status: "Filled", recruiter: "James Rodriguez" }
  ];
