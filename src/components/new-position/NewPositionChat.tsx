...
export function NewPositionChat() {
  const { messages, addMessage, showPrioritySelection } = useNewPosition();
  ...
  const handleSendMessage = () => {
    ...
    addMessage({ sender: 'user', content: currentMessage, name: 'Roney' });
    setCurrentMessage('');
  ...
  return (
    <div className="h-full bg-[#FEFEFF] flex flex-col shadow-[inset_4px_0_12px_rgba(120,0,211,0.04)]">
      {/* Chat Header */}
