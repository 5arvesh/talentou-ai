...
import { Target, TrendingUp, DollarSign, Award, ArrowLeft, MessageCircle, Database, Share2, LineChart } from "lucide-react";
  ...
  return (
    <div className="px-8 mt-6 h-screen flex flex-col">
      ...
      <div className="mt-6">
        <Button
          variant="ghost"
          onClick={() => navigate("/ta-associate-plan/message-plan-chat")}
          ...
          <Card className="min-h-64">
            ...
            <CardContent>
              <div className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                At Ignitho, you'll work at the intersection of innovation and impact, building cutting-edge digital products for global enterprises. With the agility of a startup and the stability of a growth-stage company, we offer a highly collaborative and entrepreneurial environment where teams work closely with senior leaders and clients. You'll have the freedom to lead, the opportunity to upskill rapidly, and the ability to see your work make a real difference. If you're seeking purpose, growth, and a future-proof tech career, this is where it begins.
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="min-h-64">
            ...
            <CardContent>
              <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <div className="flex items-start gap-2">
                  <span className="text-green-600 dark:text-green-400 mt-1">•</span>
                  <span>Acts as a launchpad for professionals aiming to grow into leadership roles.</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-green-600 dark:text-green-400 mt-1">•</span>
