...
export function JobListSalesPlan() {
  const allJobs: JobItem[] = [
    ...
    { id: 3, jobRole: "Senior Developer", status: "Active", recruiter: "Emma Rodriguez", hiringLead: "John Smith", priority: "High", stalledCount: 2, approvalMethod: "auto" },
    ...
    { id: 7, jobRole: "Backend Developer", status: "Filled", recruiter: "Anna Davis", hiringLead: "Carlos Martinez", priority: "High", approvalMethod: "manual" },
  ];
